...
\newfontfamily{\A}[Scale=0.85]{Arial Unicode MS}
...
\def\ptitle{Tours de magie} %% Subject's main title
\def\psubtitle{\og Windowsium Levista ! \fg} %% Subject's sub title

\def\plogo{prologin2014.pdf} %% Logo
